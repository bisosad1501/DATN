    ...
    return (
      <InstructorLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-muted-foreground">{t('loading_students')}</div>
        </div>
      </InstructorLayout>
    )
  }
  ...
  return (
    <InstructorLayout>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-foreground">{t('my_students')}</h1>
          <p className="text-muted-foreground mt-1">{t('track_student_progress_and_performance')}</p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="p-4">
            <div className="text-sm text-muted-foreground">{t('total_students')}</div>
            <div className="text-2xl font-bold text-foreground mt-1">{students.length}</div>
          </Card>
          <Card className="p-4">
            <div className="text-sm text-muted-foreground">{t('active_this_week')}</div>
          ...
          <Card className="p-4">
            <div className="text-sm text-muted-foreground">{t('avg_completion')}</div>
            <div className="text-2xl font-bold text-foreground mt-1">
          ...
          <Card className="p-4">
            <div className="text-sm text-muted-foreground">{t('avg_score')}</div>
            <div className="text-2xl font-bold text-foreground mt-1">
              {students.length > 0
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="text-xs text-muted-foreground">{t('avg_score')}</div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="text-xs text-muted-foreground">{t('study_time')}</div>
        ...
        {filteredStudents.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">{t('no_students_found')}</h3>
